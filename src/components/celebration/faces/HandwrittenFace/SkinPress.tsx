          ...
          {rows.map((r, i) =>
            r.kind === 'block' ? (
              <div key={i} style={{ display: 'flex', alignItems: 'baseline', gap: 8, marginTop: i ? 12 : 0, marginBottom: 2 }}>
                ...
                <BlockHeaderRule ruled={r.ruled} color="rgba(33,29,21,0.2)" />
                {r.score && (
                  ...
                  <div style={{
                    ...
                    {parts.isStrength ? (
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', lineHeight: 1.05 }}>
                        ...
                        {parts.me && (
                          <span style={parts.meIsLoad ? loadVoice('rgba(33,29,21,0.55)') : { fontFamily: fB, fontSize: 13, fontWeight: 800, color: 'rgba(33,29,21,0.82)', marginTop: 2, whiteSpace: 'nowrap' }}>
                            {parts.me}
                          </span>
                        )}
                      </div>
        ...
        <div style={{ marginTop: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', gap: 8 }}>
          <div style={{ minWidth: 0 }}>
            ...
            <ResultValue
              ...
              scoreLabelStyle={{ color: 'rgba(33,29,21,0.62)' }}
              scoreDividerColor="rgba(33,29,21,0.3)"
              primaryStyle={{
          ...
          {vibe && (
            <DraggableVibeStamp offset={vibeOffset} onMove={onVibeMove} onDrop={onVibeDrop} onLongPress={onVibeLongPress}>
              <VibeStamp vibe={vibe} scale={0.78} surface="light" />
            </DraggableVibeStamp>
          )}
        </div>
      </div>
