...
export function SkinSlab({ wod, vibe }: SkinSlabProps): React.JSX.Element {
  ...
  return (
    <div style={{
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr max-content', alignItems: 'center', gap: 16, padding: '3px 0' }}>
                    ...
                    {parts.isStrength ? (
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', lineHeight: 1.05 }}>
                        <span style={{ fontFamily: fH, fontSize: 19, fontWeight: 700, color: BRAND.yellow, transform: 'rotate(-2deg)', display: 'inline-block', whiteSpace: 'nowrap' }}>
                          {parts.team}
                        </span>
                        {parts.me && (
        ...
        <div style={{ marginTop: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', gap: 8 }}>
          <div style={{ minWidth: 0 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-end', gap: 8, flexWrap: 'nowrap' }}>
              <span style={{ fontFamily: fD, fontSize: 90, fontWeight: 900, lineHeight: 0.88, letterSpacing: '-0.03em', color: BRAND.yellow, textShadow: `0 0 40px ${BRAND.yellow}40`, whiteSpace: 'nowrap' }}>
      ...
      {/* Yellow brand strip — RX/PR badge + wordmark */}
