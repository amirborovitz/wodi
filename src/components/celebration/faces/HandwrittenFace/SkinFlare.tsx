                ...
                <React.Fragment key={i}>
                  <div style={stationRowChrome({ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) max-content', alignItems: 'center', gap: 16, padding: '3px 0', borderBottom: '1px solid rgba(0,0,0,0.08)' }, parts.isStation, null)}>
                    ...
                    {parts.isStrength ? (
                      ...
                      <span style={parts.singleIsLoad ? loadVoice('rgba(0,0,0,0.5)') : { fontFamily: fH, fontSize: 20, fontWeight: 700, color: BRAND.ink, transform: 'rotate(-2deg)', display: 'inline-block', whiteSpace: 'nowrap' }}>
                        {parts.single}
                      </span>
                    ) : <span />}
                  </div>
